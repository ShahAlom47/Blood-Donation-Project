...
import useNodeMailer from "../../../CustomHocks/useNodeMailer";
...
const ForgetPassword = () => {
    ...
    const sendOtp = () => {
        ...
        if (newOTP) {
            const mailOptions = {
                from: 'niscupbalok88@gmail.com',
                to: accountFound?.email,
                subject: 'Verification OTP for password Verify',
                ...
                <div className=" lg:w-6/12 md:w-8/12 w-full mx-auto shadow-4-side p-5">
                    {accountFound ?
                        <div className=" flex flex-col justify-center items-center my-4">
                            ...
                            <button onClick={sendOtp} className="btn bg-blue-800 hover:bg-blue-900 text-white rounded-sm">Yes, it`s me</button>
                        </div>
                        : <div>
