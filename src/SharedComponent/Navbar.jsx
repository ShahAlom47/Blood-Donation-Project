...
const Navbar = () => {
    ...
    const nav = <>
        <NavLink className={`hover:underline animate__animated animate__bounceInUp `}>Home</NavLink>
        <NavLink className={`hover:underline animate__animated animate__bounceInUp`}>About Us</NavLink>
